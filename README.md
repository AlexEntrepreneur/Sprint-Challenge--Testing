...
- `describe()` groups together several related tests. Good for categorising and separating tests by file/component.
- `it()` groups together assertions within a given test. Good for defining tests and describing the expected output of the assertion.

2. **What is the point of `Test Driven Development`? What do you think about this approach?**
- TDD encourages fewer code defects, simpler code solutions and more robust code
- I enjoy this approach as it encourages me to approach problems more functionally. I prefer however to manually test UI functionality as simulations can get a bit tedious.
